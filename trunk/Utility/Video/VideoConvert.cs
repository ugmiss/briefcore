...
public class VideoConvert : System.Web.UI.Page
{
    ...
    #region 配置
    public static string ffmpegtool = "";
    public static string mencodertool = "";
    public static string savefile = "";
    public static string sizeOfImg = "";
    public static string widthOfFile = "";
    public static string heightOfFile = "";
    #endregion
