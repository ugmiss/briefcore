...
namespace System
{
    ...
    public static class StringExtensions
    {
        ...
        public static void WriteToFile(this string s, Type name)
        {
            using (StreamWriter sw = new StreamWriter(name.Name + ".xml", false))
            {
                sw.Write(s);
            }
        }
        ...
        /// <param name="path"></param>
        /// <returns></returns>
        public static string ReadFromFile(this string s, Type name)
        {
            if (File.Exists(name.Name + ".xml"))
                using (StreamReader sr = new StreamReader(name.Name + ".xml"))
                {
                    StringBuilder sb = new StringBuilder();
                    do
                    {
    ...
    {
        public static string DurationToNow(this DateTime datetime)
        {
            int t = Convert.ToInt32((DateTime.Now - datetime).TotalSeconds);
            return t / 3600 / 24 + "天" + t % (3600 * 24) / 3600 + "小时" + t / 60 % 60 + "分" + t % 60 + "秒";
        }

        public static int TotalHourToNow(this DateTime datetime)
        {
            int t = Convert.ToInt32((DateTime.Now - datetime).TotalSeconds);
            return t % (3600 * 24) / 3600;
        }

        public static double TotalSecondToNow(this DateTime datetime)
        {
